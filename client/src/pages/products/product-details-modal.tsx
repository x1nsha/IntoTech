...
export default function ProductDetailsModal({ product, onClose }: { product: Product; onClose: () => void })
{
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 md:p-6" onClick={handleBackdrop} role="dialog" aria-modal="true" aria-label={`Details for ${product.name}`}>
      <div className="relative w-full max-w-4xl bg-white/10 border border-white/20 rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="relative h-80 md:h-[28rem] bg-black/40">
          ...
          <div className="p-6 md:p-10 text-white">
            ...
            <h2 className="text-2xl md:text-4xl font-bold mb-3">{product.name}</h2>
            <div className="text-indigo-300 text-2xl font-semibold mb-4">
